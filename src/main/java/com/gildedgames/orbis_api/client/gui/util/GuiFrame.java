...
public abstract class GuiFrame extends GuiContainer implements IGuiFrame
{
	...
	private final IGuiFrame prevFrame;
	...
	public GuiFrame(IGuiFrame prevFrame, final Rect rect)
	{
		this(prevFrame, rect, new ContainerGeneric());
	}

	public GuiFrame(IGuiFrame prevFrame, final Rect rect, final Container inventorySlotsIn)
	{
