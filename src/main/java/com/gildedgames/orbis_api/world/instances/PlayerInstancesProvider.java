...
public class PlayerInstancesProvider implements ICapabilitySerializable<NBTBase>
{
	...
	{
		return capability == OrbisAPICapabilities.PLAYER_INSTANCES;
	}
	...
	{
		return this.storage.writeNBT(OrbisAPICapabilities.PLAYER_INSTANCES, this.fetchCapability(), null);
	}

	@Override
	public void deserializeNBT(final NBTBase nbt)
	{
		this.storage.readNBT(OrbisAPICapabilities.PLAYER_INSTANCES, this.fetchCapability(), null, nbt);
	}
