...
public abstract class AbstractPersistingCache<K, V> implements Cache<K, V>
{
	...
	public V getIfPresent(Object key)
	{
		...
		{
			K castKey = (K) key;
			return this.underlyingCache.get(castKey);
		}
	...
	{
		return this.underlyingCache.get(key, new PersistedStateValueLoader(key, valueLoader));
	}
	...
	public long size()
	{
		return this.underlyingCache.size() + this.sizeOfPersisted();
	}
