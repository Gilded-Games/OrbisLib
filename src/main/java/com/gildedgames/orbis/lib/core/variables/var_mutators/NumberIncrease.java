...
public class NumberIncrease<NUMBER extends Number & Comparable<NUMBER>> extends NumberMutateBase<NUMBER>
{
	...
	public NumberIncrease(IGuiVar<NUMBER, ?> valueVar)
	{
		super(valueVar);
	}
